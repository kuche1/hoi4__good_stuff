...
NDefines.NProduction.BASE_FACTORY_SPEED_MIL = NDefines.NProduction.BASE_FACTORY_SPEED_MIL * 0.6 -- default 4.5 -- make mils produce less
NDefines.NProduction.BASE_FACTORY_SPEED_NAV = NDefines.NProduction.BASE_FACTORY_SPEED_NAV * 0.6 -- default 2.5 -- make docs produce less
