...
-- max armiy size
NDefines.NMilitary.CORPS_COMMANDER_DIVISIONS_CAP = 128 -- default 24
NDefines.NMilitary.FIELD_MARSHAL_DIVISIONS_CAP = 128 -- setting this to 0 brakes the AI -- default 24
NDefines.NMilitary.FIELD_MARSHAL_ARMIES_CAP = 128 -- default 5
