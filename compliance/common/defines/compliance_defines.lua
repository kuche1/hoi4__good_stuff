...
NDefines.NResistance.COMPLIANCE_GROWTH_BASE = NDefines.NResistance.COMPLIANCE_GROWTH_BASE * 1.2

-- compliance growth when at piece
-- `10` stands for `10%`
-- default 10
NDefines.NResistance.COMPLIANCE_GROWTH_IS_AT_PEACE = NDefines.NResistance.COMPLIANCE_GROWTH_IS_AT_PEACE * 1.2

-- compliance growth if claim
-- default 5
NDefines.NResistance.COMPLIANCE_GROWTH_HAS_CLAIM = NDefines.NResistance.COMPLIANCE_GROWTH_HAS_CLAIM * 1.2
